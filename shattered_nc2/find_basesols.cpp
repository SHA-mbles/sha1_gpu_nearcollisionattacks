...
*/
	...
	for (int W13t1b = 0; W13t1b < 2; ++W13t1b) { m1[13] ^= 0x11e4002; m1[14] ^= 0x51b000; m1[15] ^= 0x40baa804; 
	    ...
	    // Extra conditions for new boomerangs
	    // Should be integrated better, but this will do for early tests...
	    ...
	    // Broken by neutral bits W10[6..10] => test later
	    // if ((Q1[Qoffset+10]^Q1[Qoffset+11]) & 0b1110000)
	    // continue;
	    if ((Q1[Qoffset+12]^m1[11]) & 0b1110000)
	      continue;
	    if (( Q1[Qoffset+13]) & 0b11100)
	      continue;
	    if ((~Q1[Qoffset+14]) & 0b11100)
	      continue;
